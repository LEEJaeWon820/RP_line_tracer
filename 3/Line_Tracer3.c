...
Mat Draw_Guide_Line(Mat img) {
    ...
    rectangle(result_img, Point(50, ASSIST_BASE_LINE - ASSIST_BASE_WIDTH), Point(IMG_Width - 50, ASSIST_BASE_LINE + ASSIST_BASE_WIDTH), Scalar(236, 199, 113), 1, LINE_AA);
    ...
    line(result_img, Point(line_center, ASSIST_BASE_LINE - guide_height1 * 1), Point(line_center, ASSIST_BASE_LINE + guide_height1 * 1), Scalar(0, 0, 255), 2, 0);
